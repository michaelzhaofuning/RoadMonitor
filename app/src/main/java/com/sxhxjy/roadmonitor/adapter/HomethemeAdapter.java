...
public static class ViewHolder extends RecyclerView.ViewHolder {
	...
	public ViewHolder(View itemView) {
		super(itemView);
		name=(TextView)itemView.findViewById(com.sxhxjy.roadmonitor.R.id.tv_home_theme);
		theme_layout= (LinearLayout) itemView.findViewById(com.sxhxjy.roadmonitor.R.id.theme_layout);
	}
}
//点击事件接口
