...
import com.sxhxjy.towermonitor.adapter.HomeAdapter;
import com.sxhxjy.towermonitor.adapter.HomethemeAdapter;
...
import com.sxhxjy.towermonitor.entity.HomeTheme;
...
import com.sxhxjy.towermonitor.view.MonitorMapView;
...
//        getplace();
        ...
        getMessage(getHttpService().getHomeTowers(loginData.getUser().getGid()
